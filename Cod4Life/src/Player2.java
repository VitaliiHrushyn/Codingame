...
// System.err.println("highest dataList.helth "+dataList.getBestData().getHealth());
    ...
    public static String action() {
    	...
    	String target = myBot.getTarget(); // SAMPLES
    	
    	if ((target.equals("LABORATORY") || target.equals("START_POS")) && (!myBot.isAnyData() && !myBot.isAnyMolecule())){ 
    		return goTo();
    	}
    	if (target.equals("SAMPLES") && myBot.isAnyData()){ 
    		return goTo();
    	}
    	if (target.equals("DIAGNOSIS") && diagnosed){
 ...
 //   	return "GOTO DIAGNOSIS";
    ...
    public static String connect() {
    	...
    	if(target.equals("SAMPLES")) {
    		id = ""+dataList.getBestRankData(); // concatenation: ""+int
    	}
    	if(target.equals("DIAGNOSIS")) {    		
    		diagnosed = !diagnosed;
    		id = ""+dataList.getMyData().getSampleId(); // concatenation: ""+int
    	}
    	else if (target.equals("MOLECULES")) {
    		 System.err.println("stcost A "+dataList.getMyData().getCostA());
    		 System.err.println("stcost B "+dataList.getMyData().getCostB());
    		 System.err.println("stcost C "+dataList.getMyData().getCostC());
    		 System.err.println("stcost D "+dataList.getMyData().getCostD());
    		 System.err.println("stcost E "+dataList.getMyData().getCostE());
    		id = getMolecule();
    	}
   ...
   static class DataList {
    	...
    	public int getBestRankData () {  // now by health score
