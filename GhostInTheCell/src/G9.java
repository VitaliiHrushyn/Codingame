 ...
 **/
class Player { /// rename to Player (version 9)
...
//System.err.println("cyb, id= "+arg2+", "+entityId);
    ...
    /*            	int arg1_owner = arg1;
                	int arg2_leave = arg2; // from factory
                	int arg3_target = arg3; // to factory
                	int arg4_cybCount = arg4;
               		int arg5_turnsToArrive = arg5;
     */            	
                	Factory factory = getFactory(allFactories, arg3);
                	if (arg1 == 1) {
                		factory.needCyborg -= arg4;
                	} else {
                		factory.needCyborg += arg4;
                	}
...
/////////////////////////////////////////////////////
    ...
    static class Troop {
    	private int arg1_owner; // 1 - mine, -1 - enemy
    	private int arg2_leave; // from factory
    	private int arg3_target; // to factory
    	private int arg4_cybCount;
    	private int arg5_turnsToArrive;
    }
...
//System.err.println("get action: factory id= "+this.id+", source id= "+sourceFactory.id);
			...
			boolean permitMove = (INC_VALUE <= sourceFactory.arg3_production || myFactoriesAmount < MIN_MY_FACTORIES_AMOUNT || 
					myFactoriesAmount < 2);
			boolean permitToNeutral = (true);
			boolean needCyb = (this.needCyborg > 0);
...
///////////////////    NEUTRAL   ///////////////////////			
			if (this.arg1_owner == NEUTRAL) {
				...
				if (permitMove && permitToNeutral && needCyb) {  // ????????????????????????????????/
					sourceFactory.removeSyborg(cybCount);
					return MOVE+details+" "+cybCount;
					}
					return "";
