...
//System.err.println("new Cell x = "+this.x+", y = "+this.y+", level = "+this.level);
		...
		public Cell getNextCell(List<Cell> cellList) {
			for (Cell cell : cellList) {
				if (Math.abs(this.x - cell.x) <= 1 && Math.abs(this.y - cell.y) <= 1 && this.level - cell.level >= -1) {
					return cell;
				}
			}
			return null;
...
//==========================================================================================================================
   ...
   static List<Graph> getGraphList(Unit unit, List<Cell> cellList) {
